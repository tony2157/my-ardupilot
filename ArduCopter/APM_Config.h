...
#define USER_VPBATT_MNTR_LOOP user_vpbatt_monitor();                  // Battery monitor optimized for vertical soundings
#define USER_TEMPERATURE_LOOP user_temperature_logger();        // BLISS iMet sensors logged at 10Hz 
#define USER_HUMIDITY_LOOP user_humidity_logger();            // BLISS HYT271 sensors logged at 10Hz
#define USER_WIND_LOOP user_wind_vane();                    // BLISS wind vane mode
